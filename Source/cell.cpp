...
Cell::Cell(int x, int y)
{
	...
	top = SDL_Rect{ x, y, CELL_WIDTH, CELL_OUTLINE };
	bottom = SDL_Rect{ x, (y + CELL_HEIGHT) - CELL_OUTLINE, CELL_WIDTH, CELL_OUTLINE };
	left = SDL_Rect{ x, y, CELL_OUTLINE, CELL_HEIGHT };
	right = SDL_Rect{ (x + CELL_WIDTH) - CELL_OUTLINE, y, CELL_OUTLINE, CELL_HEIGHT };
/*
	walls.push_back(top);
