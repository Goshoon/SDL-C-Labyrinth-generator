...
g++ %OBJECTS% -L ./Dependencies/SDL2/lib -o ./Bin/run.exe -static-libgcc -static-libstdc++ -lmingw32 -Wpedantic -Wmaybe-uninitialized -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf
 if errorlevel 1 (
